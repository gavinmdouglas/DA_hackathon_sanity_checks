...
# Save RDS files of intermediate objects
```{r}
saveRDS(object = fixed_hackathon_metadata_unfilt, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/fixed_hackathon_metadata_unfilt.rds")
saveRDS(object = fixed_hackathon_metadata_filt, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/fixed_hackathon_metadata_filt.rds")

saveRDS(object = unfilt_rhos_df, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/unfilt_rhos_df.rds")
saveRDS(object = filt_rhos_df, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/filt_rhos_df.rds")

saveRDS(object = unfilt_pvals_df, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/unfilt_pvals_df.rds")
saveRDS(object = filt_pvals_df, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/filt_pvals_df.rds")

saveRDS(object = Alpha_order_unfilt, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/Alpha_order_unfilt.rds")
saveRDS(object = fix_raw_counts_unfilt, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/fix_raw_counts_unfilt.rds")

saveRDS(object = Alpha_order_filt, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/Alpha_order_filt.rds")
saveRDS(object = order_raw_count_df, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/order_raw_count_df_filt.rds")


saveRDS(object = filt_sig_percent_fix, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/filt_sig_percent_fix.rds")
saveRDS(object = unfilt_sig_percent_fix, file = "/home/gavin/projects/hackathon/sanity_checks/fig1_fig2_intermediate_objects/unfilt_sig_percent_fix.rds")
```
